...
<div className="mt-1 sm:mt-1 flex flex-col items-end gap-2 sm:flex-row sm:items-center sm:gap-5">
...
<div className="order-1 sm:order-none flex items-center gap-4">
